...
wget --no-check-certificate -q https://raw.githubusercontent.com/radim-ek/mpower-tools/HomeAssistant_master/mqtt/client/install-client.sh -O /var/etc/persistent/mqtt/install-client.sh;chmod 755 /var/etc/persistent/mqtt/install-client.sh;/var/etc/persistent/mqtt/install-client.sh
